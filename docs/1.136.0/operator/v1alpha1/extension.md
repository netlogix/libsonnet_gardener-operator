---
permalink: /1.136.0/operator/v1alpha1/extension/
---
      ...
      * [`obj spec.deployment.admission.runtimeCluster`](#obj-specdeploymentadmissionruntimecluster)
        * [`obj spec.deployment.admission.runtimeCluster.helm`](#obj-specdeploymentadmissionruntimeclusterhelm)
          * [`obj spec.deployment.admission.runtimeCluster.helm.ociRepository`](#obj-specdeploymentadmissionruntimeclusterhelmocirepository)
            ...
            * [`obj spec.deployment.admission.runtimeCluster.helm.ociRepository.caBundleSecretRef`](#obj-specdeploymentadmissionruntimeclusterhelmocirepositorycabundlesecretref)
              * [`fn withName(name)`](#fn-specdeploymentadmissionruntimeclusterhelmocirepositorycabundlesecretrefwithname)
      ...
      * [`obj spec.deployment.admission.virtualCluster`](#obj-specdeploymentadmissionvirtualcluster)
        * [`obj spec.deployment.admission.virtualCluster.helm`](#obj-specdeploymentadmissionvirtualclusterhelm)
          * [`obj spec.deployment.admission.virtualCluster.helm.ociRepository`](#obj-specdeploymentadmissionvirtualclusterhelmocirepository)
            ...
            * [`obj spec.deployment.admission.virtualCluster.helm.ociRepository.caBundleSecretRef`](#obj-specdeploymentadmissionvirtualclusterhelmocirepositorycabundlesecretref)
              * [`fn withName(name)`](#fn-specdeploymentadmissionvirtualclusterhelmocirepositorycabundlesecretrefwithname)
    ...
    * [`obj spec.deployment.extension`](#obj-specdeploymentextension)
      ...
      * [`obj spec.deployment.extension.helm`](#obj-specdeploymentextensionhelm)
        * [`obj spec.deployment.extension.helm.ociRepository`](#obj-specdeploymentextensionhelmocirepository)
          ...
          * [`obj spec.deployment.extension.helm.ociRepository.caBundleSecretRef`](#obj-specdeploymentextensionhelmocirepositorycabundlesecretref)
            * [`fn withName(name)`](#fn-specdeploymentextensionhelmocirepositorycabundlesecretrefwithname)
...
## obj spec.deployment.admission.runtimeCluster.helm.ociRepository.caBundleSecretRef
...
### fn spec.deployment.admission.runtimeCluster.helm.ociRepository.caBundleSecretRef.withName
...
## obj spec.deployment.admission.virtualCluster.helm.ociRepository.caBundleSecretRef

"CABundleSecretRef is a reference to a secret containing a PEM-encoded certificate authority bundle.\nThe CA bundle is used to verify the TLS certificate of the OCI registry.\nThe secret must have a data key `bundle.crt` and must be located in the `garden` namespace.\nFor usage in the gardenlet, the secret must have the label `gardener.cloud/role=oci-ca-bundle`.\nIf not provided, the system's default certificate pool is used."

### fn spec.deployment.admission.virtualCluster.helm.ociRepository.caBundleSecretRef.withName
...
## obj spec.deployment.extension.helm.ociRepository.caBundleSecretRef

"CABundleSecretRef is a reference to a secret containing a PEM-encoded certificate authority bundle.\nThe CA bundle is used to verify the TLS certificate of the OCI registry.\nThe secret must have a data key `bundle.crt` and must be located in the `garden` namespace.\nFor usage in the gardenlet, the secret must have the label `gardener.cloud/role=oci-ca-bundle`.\nIf not provided, the system's default certificate pool is used."

### fn spec.deployment.extension.helm.ociRepository.caBundleSecretRef.withName
