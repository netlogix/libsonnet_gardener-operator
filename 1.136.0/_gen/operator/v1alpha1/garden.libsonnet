{
  ...
  spec: {
    ...
    '#resources':: d.obj(help='"Resources holds a list of named resource references that can be referred to in extension configs by their names."'),
    resources: {
      '#resourceRef':: d.obj(help='"ResourceRef is a reference to a resource."'),
      resourceRef: {
      ...
      '#withName':: d.fn(help='"Name of the resource reference."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    },
    ...
    virtualCluster: {
      ...
      gardener: {
        ...
        gardenerAPIServer: {
          ...
          encryptionConfig: {
            '#provider':: d.obj(help='"Provider contains information about the encryption provider."'),
            provider: {
              '#withType':: d.fn(help='"Type contains the type of the encryption provider.\\n\\nSupported types:\\n  - \\"aescbc\\"\\nDefaults to aescbc."', args=[d.arg(name='type', type=d.T.string)]),
              withType(type): { spec+: { virtualCluster+: { gardener+: { gardenerAPIServer+: { encryptionConfig+: { provider+: { type: type } } } } } } },
            },
          ...
          watchCacheSizes: {
            ...
            '#withDefault':: d.fn(help='"Default is not respected anymore by kube-apiserver.\\nThe cache is sized automatically.\\nDeprecated: This field is deprecated. Setting the default cache size will be forbidden starting from Kubernetes 1.35."', args=[d.arg(name='default', type=d.T.integer)]),
        ...
        '#gardenerResourceManager':: d.obj(help='"ResourceManager contains configuration settings for the gardener-resource-manager."'),
        gardenerResourceManager: {
          '#withAdditionalTargetNamespaces':: d.fn(help='"AdditionalTargetNamespaces allows specifying custom target namespaces for the gardener-resource-manager instance."', args=[d.arg(name='additionalTargetNamespaces', type=d.T.array)]),
          withAdditionalTargetNamespaces(additionalTargetNamespaces): { spec+: { virtualCluster+: { gardener+: { gardenerResourceManager+: { additionalTargetNamespaces: if std.isArray(v=additionalTargetNamespaces) then additionalTargetNamespaces else [additionalTargetNamespaces] } } } } },
          '#withAdditionalTargetNamespacesMixin':: d.fn(help='"AdditionalTargetNamespaces allows specifying custom target namespaces for the gardener-resource-manager instance."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalTargetNamespaces', type=d.T.array)]),
          withAdditionalTargetNamespacesMixin(additionalTargetNamespaces): { spec+: { virtualCluster+: { gardener+: { gardenerResourceManager+: { additionalTargetNamespaces+: if std.isArray(v=additionalTargetNamespaces) then additionalTargetNamespaces else [additionalTargetNamespaces] } } } } },
        },
      ...
      kubernetes: {
        ...
        kubeAPIServer: {
          ...
          encryptionConfig: {
            ...
            provider: {
              '#withType':: d.fn(help='"Type contains the type of the encryption provider.\\n\\nSupported types:\\n  - \\"aescbc\\"\\nDefaults to aescbc."', args=[d.arg(name='type', type=d.T.string)]),
              withType(type): { spec+: { virtualCluster+: { kubernetes+: { kubeAPIServer+: { encryptionConfig+: { provider+: { type: type } } } } } } },
            },
            '#withResources':: d.fn(help='"Resources contains the list of resources that shall be encrypted in addition to secrets.\\nEach item is a Kubernetes resource name in plural (resource or resource.group) that should be encrypted.\\nWildcards are not supported for now.\\nSee https://github.com/gardener/gardener/blob/master/docs/usage/security/etcd_encryption_config.md for more details."', args=[d.arg(name='resources', type=d.T.array)]),
        ...
        kubeControllerManager: {
          ...
          horizontalPodAutoscaler: {
            ...
            '#withInitialReadinessDelay':: d.fn(help='"The configurable period at which the horizontal pod autoscaler considers a Pod “not yet ready” given that it’s unready and it has  transitioned to unready during that time."', args=[d.arg(name='initialReadinessDelay', type=d.T.string)]),
    ...
    '#withResources':: d.fn(help='"Resources holds a list of named resource references that can be referred to in extension configs by their names."', args=[d.arg(name='resources', type=d.T.array)]),
    withResources(resources): { spec+: { resources: if std.isArray(v=resources) then resources else [resources] } },
    '#withResourcesMixin':: d.fn(help='"Resources holds a list of named resource references that can be referred to in extension configs by their names."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resources', type=d.T.array)]),
